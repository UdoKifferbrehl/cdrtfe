...
uses Forms, Classes, StdCtrls, ComCtrls, SysUtils, FileCtrl,
     cl_tree, f_cdtext, f_largeint, const_core, userevents;
...
uses {$IFDEF ShowDebugWindow} frm_debug, {$ENDIF}
     atl_oggvorbis,
     f_filesystem, f_locations, f_strings, cl_mpeginfo, cl_flacinfo, f_wininfo,
     cl_mpegvinfo, cl_apeinfo, f_wavefiles, const_common;
